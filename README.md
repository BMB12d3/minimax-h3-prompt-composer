...
1. Download **[H3_Prompt_Composer_V5_37_1.html](H3_Prompt_Composer_V5_37_1.html)**.
...
V5.37.1 completes the reusable Environment-location workflow: reserve a shared Picture-input bank, create multiple named locations, and map each location to the Picture subset it uses. It also restores normal completion of Guided Reference Setup and corrects the location summary shown before setup is created.
...
- **[SHA-256 checksum](H3_Prompt_Composer_V5_37_1_SHA256.txt)** — verifies the standalone HTML file.
