...
1. Download **[H3_Prompt_Composer_V5_37_2.html](H3_Prompt_Composer_V5_37_2.html)**.
...
V5.37.2 carries forward the V5.37.1 workflow and documentation while correcting visual Camera Path profile labels and preserving shot-size and distance changes in generated camera instructions.
